...
const CardList = () => {
  ...
  const handleConfirmDelete = async () => {
    try {
      const response = await fetch(`/api/blog/delete?id=${selectedBlog}`, {
        method: "DELETE",
      });
    ...
    <AdminLayout>
      <div className="w-full px-2 py-2 md:py-12">
        <div className="flex items-center justify-between mb-6 border p-1">
          ...
          <Link href="/adminDashboard/blog/create" className="text-white ">
                ...
                >
                  ...
                  <td className="  px-6 py-4 ">
                    <div className="flex text-center ">
                      <Link
                        href={`/adminDashboard/blog/update/[id]`}
                        as={`/adminDashboard/blog/update/${blog._id}`}
                      >
...
const AdminProtectedblogForm = withAdminRoute(CardList);
export default AdminProtectedblogForm;
