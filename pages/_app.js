...
export default function App({ Component, pageProps }) {
  ...
  const adminRoutes = ["/adminDashboard/message/list","/adminDashboard/user/list","/adminDashboard","/adminDashboard/blog/create","/adminDashboard/blog/update","/adminDashboard/user/users","/adminDashboard/category/create","/adminDashboard/introduction/list","/adminDashboard/introduction/create","/adminDashboard/introduction/update","/adminDashboard/course/create"]; // Add the routes for your admin pages here.
